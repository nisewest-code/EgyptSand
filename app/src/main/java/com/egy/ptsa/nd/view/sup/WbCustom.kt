package com.egy.ptsa.nd.view.sup
...
import com.egy.ptsa.nd.activity.ActivityLaunchEgyptScreen
...
import com.egy.ptsa.nd.utils.sandSuppoer.MPclMilkey
import com.egy.ptsa.nd.utils.sandSuppoer.MissingHelth
import com.egy.ptsa.nd.utils.sandSuppoer.MissingPiggR
import com.egy.ptsa.nd.view.Stack
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class WbCustom(private val context: ActivityLaunchEgyptScreen, private val binding: ActivityLaunchEgyptScreenBinding, private val listener: ActivityResultLauncher<Intent>) {
...
//                Analytics.openUrl(lastUrl)
    ...
    private inner class MisisngClz(val activity: ActivityLaunchEgyptScreen) : WebChromeClient() {
        override fun onHideCustomView() {
            binding.apply {
                binding.containerEqyptSand.removeView(mFullScreenView)
                mFullscreenViewCallback?.onCustomViewHidden()
                mFullScreenView = null
                webView.visibility = View.VISIBLE
                binding.containerEqyptSand.visibility = View.GONE
            }
        }
        ...
        override fun onShowCustomView(view: View?, callback: CustomViewCallback?) {
            binding.apply {
                ...
                binding.containerEqyptSand.visibility = View.VISIBLE
                binding.containerEqyptSand.addView(view)
